...
var (
	_ function.Function = GetClosestInferiorGCPCloudNatDynamicPortFunction{}
)

func NewGetClosestInferiorGCPCloudNatDynamicPortFunction() function.Function {
	return GetClosestInferiorGCPCloudNatDynamicPortFunction{}
}

type GetClosestInferiorGCPCloudNatDynamicPortFunction struct{}

func (r GetClosestInferiorGCPCloudNatDynamicPortFunction) Metadata(_ context.Context, req function.MetadataRequest, resp *function.MetadataResponse) {
	resp.Name = "GetClosestInferiorGCPCloudNatDynamicPortFunction"
}

func (r GetClosestInferiorGCPCloudNatDynamicPortFunction) Definition(_ context.Context, _ function.DefinitionRequest, resp *function.DefinitionResponse) {
...
func (r GetClosestInferiorGCPCloudNatDynamicPortFunction) Run(ctx context.Context, req function.RunRequest, resp *function.RunResponse) {
	var portType string
